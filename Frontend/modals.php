...
<div id="deleteBudgetModal" class="modal">
  <div class="modal-content">
    <span class="close" onclick="closeModal('deleteBudgetModal')">&times;</span>
    <h3>Delete Budget</h3>
    <p>Are you sure you want to delete this budget?</p>
    <form method="POST" id="deleteBudgetForm">
      <input type="hidden" name="budget_id" id="delete_budget_id">
      <input type="submit" value="Yes, Delete">
      <button type="button" onclick="closeModal('deleteBudgetModal')">Cancel</button>
    </form>
  </div>
</div>
...
<div id="deleteSavingsModal" class="modal">
  <div class="modal-content">
    <span class="close" onclick="closeModal('deleteSavingsModal')">&times;</span>
    <h3>Delete Saving Goal</h3>
    <p>Are you sure you want to delete this saving goal?</p>
    <form method="POST" id="deleteSavingsForm">
      <input type="hidden" name="saving_id" id="delete_saving_id">
      <input type="submit" value="Yes, Delete">
